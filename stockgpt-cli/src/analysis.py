...
def analyze_data(data: pd.DataFrame) -> dict:
    ...
    analysis['bb_dates'] = upper_band.dropna().index.tolist()
    analysis['bb_upper'] = upper_band.dropna().values.tolist()
    analysis['bb_middle'] = middle_band.dropna().values.tolist()
    analysis['bb_lower'] = lower_band.dropna().values.tolist()
